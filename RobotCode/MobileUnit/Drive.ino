...
#define THETA_PRECISION  .01 // Must be this many radians from target angle for success
...
int driveTurn(double newTheta, boolean useLines) {
  ...
  while(newTheta - currentLocation.theta > TARGET_PRECISION) {
      ...
      else if (newTheta - currentLocation.theta > umbrella + STRAY_ERROR) {globalError = 5; return 5;} // Stray error
